...
initiative1 = random.randint(1,20) + partyDict["Shadowheart"]["Init"]
initiative2 = random.randint(1,20) + enemyDict["Orc"]["Init"]
...
while partyDict["Shadowheart"]["HP"] > 0 and enemyDict["Orc"]["HP"] > 0:
    ...
    if initiative1 >= initiative2:
        ...
        if d20 >= 13 and d20 < 20:
            ...
            print(f"The enemy now has {enemyDict["Orc"]["HP"]} health.")
            time.sleep(0.5)
            initiative1 = 1
            initiative2 = 2
        elif d20 == 20:
            ...
            time.sleep(0.5)
            enemyDict["Orc"]["HP"] -= (random.randint(1, 6) + 3) * 2
            print(f"The enemy now has {enemyDict["Orc"]["HP"]} health.")
            time.sleep(0.5)
            initiative1 = 1
            initiative2 = 2
        ...
        if d20 >= 18 and d20 < 20:
            ...
            print(f"You now have {partyDict["Shadowheart"]["HP"]} health.")
            time.sleep(0.5)
            initiative1 = 2
            initiative2 = 1
        elif d20 == 20:
            print("Critical success! Double damage.")
            time.sleep(0.5)
            partyDict["Shadowheart"]["HP"] -= (random.randint(1, 12) + 3) * 2
            print(f"You now have {partyDict["Shadowheart"]["HP"]} health.")
            time.sleep(0.5)
            initiative1 = 2
            initiative2 = 1
